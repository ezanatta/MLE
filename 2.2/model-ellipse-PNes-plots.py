...
#                pylab.plot(x/60, srsclog, color='red', linestyle='--', label='Sersic Profile (Spheroid Light)')
#                pylab.plot(x/60, exp1log, color ='blue', linestyle='--', label='Exp Disk Profile (Disk Light)')
                pylab.plot(np.log10(x/60), np.log10(totallog*20), color='black', linestyle='-', label = 'Total Light Profile (Spheroid+Disk)', dashes=[20,20,20,20,20,20])
                pylab.errorbar(rlog, np.log10(denslog), yerr=errlog, capsize=6, capthick=1, ecolor='magenta', marker = 's', markeredgecolor='magenta', markersize=10, mfc='None', label='GC', linestyle='none')
                #pylab.legend(loc='lower left', prop={'size':10})
                pylab.xlim(-0.1629650757138516,1.372349512583571)
                pylab.ylim(-3.5599437253940422,2.3839753332499747)
                ...
                pylab.plot(np.log10(x/60), np.log10(srsclog*30.0), color='black', linestyle='--', label='Sersic Profile (Spheroid Light)')
#                pylab.plot(x/60, exp1log, color ='blue', linestyle='--', label='Exp Disk Profile (Disk Light)')
#                pylab.plot(x/60, totallog, color='gray', linestyle='-', label = 'Total Light Profile (Spheroid+Disk)')
                pylab.errorbar(rlog, np.log10(denslog), yerr=errlog, capsize=6, capthick=1, ecolor='magenta', marker = 's', markeredgecolor='magenta', markersize=10, mfc='None', linestyle='none')
                #pylab.legend(loc='lower left', prop={'size':10})
                pylab.xlim(-0.1629650757138516,1.372349512583571)
                pylab.ylim(-3.5599437253940422,2.3839753332499747)
...
#                pylab.plot(x/60, srsclog, color='red', linestyle='--', label='Sersic Profile (Spheroid Light)')
                pylab.plot(np.log10(x/60), np.log10(exp1log*30.0), color ='black', linestyle='-', label='Exp Disk Profile (Disk Light)', dashes=[8, 4, 2, 4, 2, 4])                
#                pylab.plot(x/60, totallog, color='gray', linestyle='-', label = 'Total Light Profile (Spheroid+Disk)')
                pylab.errorbar(rlog, np.log10(denslog), yerr=errlog, capsize=6, capthick=1, ecolor='magenta', marker = 's', markeredgecolor='magenta', markersize=10, mfc='None', linestyle='none')
                #pylab.legend(loc='lower left', prop={'size':10})
                pylab.xlim(-0.1629650757138516,1.372349512583571)
...
#            pylab.plot(x/60, srsclog, color='red', linestyle='--', label='Sersic Profile (Spheroid Light)')
#            pylab.plot(x/60, exp1log, color ='blue', linestyle='--', label='Exp Disk Profile (Disk Light)')
            pylab.plot(np.log10(x/60), np.log10(totallog*1.0), color='black', linestyle='-', label = 'Total Light Profile (Spheroid + Disk)', dashes=[20,20,20,20,20,20])
...
#            pylab.errorbar(rlog, denslog, yerr=errlog, capsize=6, capthick=1, ecolor='magenta', marker = 'D', markeredgecolor='magenta', markersize=10, mfc='None', label='All GC', linestyle='none')
            #pylab.legend(loc='lower left', prop={'size':10})
            pylab.xlim(-0.046182777064759817,0.94197155866858173)
            pylab.ylim(-2.593040546956793,2.4646860309958711)
            ...
            pylab.plot(np.log10(x/60), np.log10(srsclog*3.0), color='black', linestyle='--', label='Sersic Profile (Spheroid Light)')
#            pylab.plot(x/60, exp1log, color ='blue', linestyle='--')
#            pylab.plot(x/60, totallog, color='gray', linestyle='-')
...
#            pylab.plot(x/60, srsclog, color='red', linestyle='--', label='Sersic Profile (Spheroid Light)')
            pylab.plot(np.log10(x/60), np.log10(exp1log), color ='black', linestyle='-', label='Exp Disk Profile (Disk Light)', dashes=[8, 4, 2, 4, 2, 4])
#            pylab.plot(x/60, totallog, color='gray', linestyle='-')
#            pylab.errorbar(rall/60, denslog+scale, yerr=errlog, capsize=6, capthick=1, ecolor='magenta', marker = 'D', markeredgecolor='magenta', markersize=10, mfc='None', linestyle='none')
            pylab.errorbar(rlog_r, np.log10(denslog_r), yerr=errlog_r, capsize=6, capthick=1, ecolor='red', marker = 'D', markeredgecolor='red', markersize=10, mfc='None', linestyle='none')
            pylab.errorbar(rlog_b, np.log10(denslog_b), yerr=errlog_b, capsize=6, capthick=1, ecolor='blue',marker = 'o', markeredgecolor='blue', markersize=10, mfc='None', linestyle='none')    
            #pylab.legend(loc='lower left', prop={'size':10})    
            pylab.xlim(-0.046182777064759817,0.94197155866858173)
            pylab.ylim(-2.593040546956793,2.4646860309958711)

# -*- coding: utf-8 -*-
"""
Created on Tue May 16 13:53:27 2017
...
def load_like_uni(op):
    if op=='GC':        
        V = np.loadtxt('/home/emilio/MLE/2.5/like_.dat', usecols=(10,))
        Verr_min = np.loadtxt('/home/emilio/MLE/2.5/error_.dat', usecols=(10,))
        Verr_max = np.loadtxt('/home/emilio/MLE/2.5/error_.dat', usecols=(11,))
        sigma = np.loadtxt('/home/emilio/MLE/2.5/like_.dat', usecols=(4,))
        sigmaerr_min = np.loadtxt('/home/emilio/MLE/2.5//error_.dat', usecols=(6,))
        sigmaerr_max = np.loadtxt('/home/emilio/MLE/2.5/error_.dat', usecols=(7,))
        R = np.loadtxt('/home/emilio/MLE/2.5/like_.dat', usecols=(7,))
        
        Rmin = np.loadtxt('/home/emilio/MLE/2.5/bin_.dat', usecols=(3,))
        Rmax = np.loadtxt('/home/emilio/MLE/2.5/bin_.dat', usecols=(4,))
        Rmin = R - Rmin
        Rmax = Rmax - R
...
def load_like_bi(op):
    ...
    if op=='redGC':    
        V = np.loadtxt('/home/emilio/MLE/2.5/like_red.dat', usecols=(10,))
        Verr_min = np.loadtxt('/home/emilio/MLE/2.5/error_red.dat', usecols=(10,))
        Verr_max = np.loadtxt('/home/emilio/MLE/2.5/error_red.dat', usecols=(11,))
        sigma = np.loadtxt('/home/emilio/MLE/2.5/like_red.dat', usecols=(4,))
        sigmaerr_min = np.loadtxt('/home/emilio/MLE/2.5/error_red.dat', usecols=(6,))
        sigmaerr_max = np.loadtxt('/home/emilio/MLE/2.5/error_red.dat', usecols=(7,))
        R = np.loadtxt('/home/emilio/MLE/2.5/like_red.dat', usecols=(7,))

        Rmin = np.loadtxt('/home/emilio/MLE/2.5/bin_red.dat', usecols=(3,))
        Rmax = np.loadtxt('/home/emilio/MLE/2.5/bin_red.dat', usecols=(4,))
        Rmin = R - Rmin
        Rmax = Rmax - R  
    ...
    if op=='blueGC':    
        V = np.loadtxt('/home/emilio/MLE/2.5/like_blue.dat', usecols=(10,))
        Verr_min = np.loadtxt('/home/emilio/MLE/2.5/error_blue.dat', usecols=(10,))
        Verr_max = np.loadtxt('/home/emilio/MLE/2.5/error_blue.dat', usecols=(11,))
        sigma = np.loadtxt('/home/emilio/MLE/2.5/like_blue.dat', usecols=(4,))
        sigmaerr_min = np.loadtxt('/home/emilio/MLE/2.5/error_blue.dat', usecols=(6,))
        sigmaerr_max = np.loadtxt('/home/emilio/MLE/2.5/error_blue.dat', usecols=(7,))
        R = np.loadtxt('/home/emilio/MLE/2.5/like_blue.dat', usecols=(7,))

        Rmin = np.loadtxt('/home/emilio/MLE/2.5/bin_blue.dat', usecols=(3,))
        Rmax = np.loadtxt('/home/emilio/MLE/2.5/bin_blue.dat', usecols=(4,))
        Rmin = R - Rmin
        Rmax = Rmax - R  
...
########################################## new plot
    ...
    if gal == '2768':
        ...
        #TODO: Add sigma_sph to this galaxies and use the average of sigmas for sigma_disk     
...
#    pV, pVerr_min, pVerr_max, psigma, psigmaerr_min, psigmaerr_max, pR, pRmin, pRmax, pVb, pVb_err_min, pVb_err_max, psigma_b, psigma_b_err_min, psigma_b_err_max = load_twocompPNE()
    ...
    print 'V/sigma for all: ', Vos
    print 'V/sigma for reds: ', Vosreds
    print 'V/sigma for blues: ', Vosblues
    
    #how to proceed with error propagation with assymetrical errorbars? let's proceed without it for now:
    
    plt.errorbar(R, Vos, yerr=[Vos_min, Vos_max], color='purple', marker='o', linestyle='none')
    plt.errorbar(R_r, Vosreds, yerr=[Vosreds_min, Vosreds_max], color='red', marker='o', linestyle='none')
    plt.errorbar(R_b, Vosblues, yerr=[Vosblues_min, Vosblues_max], color='blue', marker='o', linestyle='none')
    plt.show()

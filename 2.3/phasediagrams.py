...
#        plt.plot(rblue, Vblue, marker='o', color='blue', linestyle='None')
        ...
        plt.plot(rdiskred, vdiskred, markersize=8,marker='s', markerfacecolor='None', markeredgecolor='red', linestyle='None')
        plt.plot(rdiskblue, vdiskblue, markersize=8, marker='o', markerfacecolor='None', markeredgecolor='blue', linestyle='None')
        plt.plot(rsphred, vsphred, markersize=8, marker='s', color='red', linestyle='None')
        ...
        plt.plot(xdiskred, vdiskred, markersize=8, marker='s', markerfacecolor='None', markeredgecolor='red', linestyle='None')
        plt.plot(xdiskblue, vdiskblue, markersize=8, marker='o', markerfacecolor='None', markeredgecolor='blue', linestyle='None')
        plt.plot(xsphred, vsphred, markersize=8, marker='s', color='red', linestyle='None')

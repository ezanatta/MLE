...
#        plt.plot(rblue, Vblue, marker='o', color='blue', linestyle='None')
        plt.plot(np.sqrt(px**2+py**2), Vp, marker='o', markersize=6, markerfacecolor='lightgreen', markeredgecolor='lightgreen', linestyle='None', label= 'PNe')
        plt.plot(rdiskred, vdiskred, markersize=8,marker='o', markerfacecolor='None', markeredgecolor='red', linestyle='None')
        ...
        plt.plot(xdiskred, vdiskred, markersize=8, marker='o', markerfacecolor='None', markeredgecolor='red', linestyle='None')
